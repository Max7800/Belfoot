...
export default function MatchPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mb-8 flex items-center justify-center gap-4 rounded-3xl border border-line/10 bg-gradient-to-br from-surface via-surface2 to-bg px-4 py-7 shadow-[0_24px_70px_-42px_rgba(0,0,0,0.9)]">
      ...
      <h2 className="mb-3 text-sm font-bold uppercase tracking-wider text-muted">{L("match.events", "Faits du match")}</h2>
      {events.length === 0
