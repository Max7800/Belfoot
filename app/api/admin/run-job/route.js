...
export async function POST(req) {
  ...
  try {
    return Response.json(await runJob(body.key, { db: admin, season: body.season, competitionId: body.competitionId || null, matchCap: body.matchCap, thesportsdbKey: process.env.THESPORTSDB_KEY, apifootballKey: process.env.APIFOOTBALL_KEY }));
