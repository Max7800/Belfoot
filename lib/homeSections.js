...
export const HOME_SECTIONS = [
  { key: "live", label: "Scores en direct", subtitle: "Tous les scores, sans quitter la première page.", action: "Voir tout le direct", max_matches: 8, empty_mode: "upcoming", background_color: "#101a2d", border_color: "#7f1d2d" },
  ...
  { key: "noyau", label: "En ce moment dans Le Noyau", subtitle: "Le vote en cours et les dernières discussions.", action: "Rejoindre Le Noyau" },
...
export const HOME_COMPETITION_CAROUSEL = {
  competition_ids: [],
...
export function normalizeHomeConfig(value = {}) {
  ...
  return {
    ...
    competition_carousel: { ...HOME_COMPETITION_CAROUSEL, ...(value.competition_carousel || {}) },
