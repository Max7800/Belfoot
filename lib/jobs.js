...
const JOBS = { "football.sync": footballSync, "football.live-sync": footballLiveSync, "football.discover-belgians": footballDiscover, "football.track-belgians": footballTrack, "football.squads": footballSquads, "football.events": footballEvents, "football.coaches": footballCoaches, "football.lineups": footballLineups, "football.team-test": footballTeamTest };
...
export async function runJob(key, ctx = {}) {
  ...
  const targetKey = ctx.competitionId ? String(ctx.competitionId) : "all";
