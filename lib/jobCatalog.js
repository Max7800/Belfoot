...
export const JOB_CATALOG = {
  ...
  "football.squads": {
    label: "👥 Effectifs (joueurs)", group: "base", requires: ["football.sync"],
  ...
  "football.national-team": {
    label: "🇧🇪 Synchroniser une sélection", group: "belges",
    estimate: () => "3 appels : fiche équipe, matchs de la saison et effectif actuel",
  },
  "football.resolve-national-clubs": {
    label: "🌍 Compléter les clubs des internationaux", group: "belges", requires: ["football.national-team"],
